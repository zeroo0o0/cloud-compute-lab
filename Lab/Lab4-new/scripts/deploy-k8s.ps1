...
Invoke-Retry 5 { kubectl -n $Namespace set image statefulset/lab4-redis redis=$RedisImage }

Write-Host "==> Wait for rollout"
Invoke-Retry 5 { kubectl -n $Namespace rollout status "statefulset/lab4-redis" --timeout=240s }
$deployments = @(
  "lab4-gateway",
  "lab4-coordinator",
  "lab4-map-green",
